...
(function ($) {
	...
	function whenAllImagesLoaded(container, callback) {
        ...
        images.each(function () {
            if (this.complete) {
                ...
                $(this).one("load", incrementCounter).one("error", incrementCounter);
            }
        });
    ...
    $(document).ready(function ($) {
        whenAllImagesLoaded($("body"), function () {
            // Aquí colocamos todo el código que necesita ejecutarse después de que todas las imágenes se carguen
            // Código de inicialización y ejecución principal
            initializePage();
        });
